...
n2 = 1.34; % Refractive index of the sample
NA = 1.40; % Numerical aperture of the objective

Za = 4; % The actual z position of interest from the coverslip (um)
lambda = 560E-3;
...
disp(["Z compression ratio:",num2str(zeta)]);